...
const es: IDictionary = {
  ...
  experienceContent: {
    ...
    entryHighlights: [
      ...
      "Ayudé a impulsar la adopción de IA en el equipo de ingeniería: definí las reglas que el código generado por IA debe respetar, documenté los procesos de calidad que mantienen predecibles los flujos agénticos e integré testing automatizado asistido por IA en el pipeline de despliegue.",
